...
from src.consts import CELL_SIZE, FloorsTypes, RoomsTypes
from src.modules.base_classes import BaseItem
...
class Rock(BaseItem):
    ...
    def set_image(self):
        ...
        self.destroyed_image = Rock.rocks.subsurface(
            (texture_x, 0, CELL_SIZE, CELL_SIZE),
        )
