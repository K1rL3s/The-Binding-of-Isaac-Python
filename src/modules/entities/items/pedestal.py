...
from src.consts import CELL_SIZE, PICKUP_ART
from src.modules.base_classes import BaseArtifact, PickableItem
...
class Pedestal(PickableItem):
    ...
    pedestal = load_image("textures/room/altars.png").subsurface(
        0,
        0,
        CELL_SIZE,
        CELL_SIZE,
    ...
    def pickup(self):
        ...
        pg.event.post(pg.event.Event(PICKUP_ART, {"item": self.artifact, "self": self}))
