...
from src.modules.base_classes import BaseItem, MovableItem, MoveSprite, MovingEnemy
...
class Web(BaseItem):
    ...
    webs: list[pg.Surface] = [
        load_image("textures/room/web.png").subsurface(
            x * CELL_SIZE,
            0,
            CELL_SIZE,
            CELL_SIZE,
    ...
    destoryed: pg.Surface = load_image("textures/room/web.png").subsurface(
        3 * CELL_SIZE,
        0,
        CELL_SIZE,
        CELL_SIZE,
