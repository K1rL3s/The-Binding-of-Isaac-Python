...
from src.consts import DEATH_ENEMY, USE_BOMB, HeartsTypes
from src.modules.characters.main_hero import Player
from src.modules.entities.items import PickBomb, PickHeart, PickKey, PickMoney
