...
class BaseArtifact(MoveSprite):
    ...
    boosts = {
        ...
        "speed": 1,          # Изменение скорости ходьбы персонажа.
        "shot_speed": 1,     # Изменение скорости полёта слезы.
        "shot_distance": 1,  # Изменение дальности полёта слезы.
        "shot_delay": -1,    # Изменение задержки между выстрелами
    }
