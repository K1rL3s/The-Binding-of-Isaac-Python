...
from src.modules.base_classes.enemies.shooting_enemy import ShootingEnemy
from src.modules.characters.main_hero import Player
from src.modules.entities import ExampleTear
from src.utils.funcs import crop, load_image
...
class Host(ShootingEnemy):
    ...
    waiting_image = crop(
        load_image("textures/enemies/host2.png").subsurface(
            0,
            0,
            host_width,
            host_height,
